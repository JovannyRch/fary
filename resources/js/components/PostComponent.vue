    ...
    <div class="post w-100 pb-3">
        ...
        <div class="post-data">
            <div class="row">
                ...
                >
                  ...
                  <i>
                    <small style="color:grey">{{address}}</small>
                                ...
                                <div
                                    class="dropdown show float-right grid-2"
                                    v-if="post_user_id == user_id"
                                >
                                    <a
                                        data-toggle="modal"
                ...
                <div
                    v-if="img || imgs"
                    class="col-12 col-md-6 p-2 pl-4 text-center"
                >
...
export default {
    ...
    created() {
        if (this.user_id) {
            if (this.type == "owner" || this.type == "normal") {
