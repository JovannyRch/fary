                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="row">
                            <div
                                :class="
                                    images.length ? 'col-3 text-center' : ''
                                "
                            >
                                <img
                            ...
                            <div
                                class="col-md-6 col-md-offset-6 col-12"
                                v-show="content"
                            >
                                <div class="form-group">
                                    <label for="rango"
                                        >Seleccione rango de publicación</label
                                    >
                                    <select
                                        class="custom-select"
                                        name="rango"
                            ...
                            <div class="col-12">
                                ...
                                <button
                                    id="btn-file"
                                    type="button"
                                    class="float-right btn btn-success btn-sm mr-2"
                                >
