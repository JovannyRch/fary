                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a type="button" href="{{route('car.show',$post->id)}}" >
                                Ver
                            </a>
                        <a href="#" data-toggle="modal" data-target="#delete-user" data-action="{{route('car.destroy','')}}" data-name="{{$post->piece}}"  data-id="{{$post->id}}" >
                           Eliminar
                        </a>
